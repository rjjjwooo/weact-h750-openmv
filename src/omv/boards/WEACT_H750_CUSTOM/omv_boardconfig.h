...
// Architecture info
#define OMV_ARCH_STR            "WEACT H750 OV7725+W5500" // 33 chars max
...
// Enable sensor drivers (OV7725 focus for beacon detection)
#define OMV_ENABLE_OV2640       (0)
#define OMV_ENABLE_OV5640       (0)
#define OMV_ENABLE_OV7690       (0)
#define OMV_ENABLE_OV7725       (1)  // Primary sensor for beacon detection
...
// W5500 Ethernet SPI (SPI3)
#define W5500_SPI                   (SPI3)
#define W5500_SPI_PRESCALER         (SPI_BAUDRATEPRESCALER_4)
#define W5500_SPI_IRQn              (SPI3_IRQn)
#define W5500_SPI_IRQHandler        (SPI3_IRQHandler)

#define W5500_SPI_DMA_IRQn          (DMA1_Stream0_IRQn)
#define W5500_SPI_DMA_STREAM        (DMA1_Stream0)
#define W5500_SPI_DMA_REQUEST       (DMA_REQUEST_SPI3_RX)
#define W5500_SPI_DMA_IRQHandler    (DMA1_Stream0_IRQHandler)

#define W5500_SPI_RESET()           __HAL_RCC_SPI3_FORCE_RESET()
#define W5500_SPI_RELEASE()         __HAL_RCC_SPI3_RELEASE_RESET()
#define W5500_SPI_CLK_ENABLE()      __HAL_RCC_SPI3_CLK_ENABLE()
#define W5500_SPI_CLK_DISABLE()     __HAL_RCC_SPI3_CLK_DISABLE()
#define W5500_SPI_DMA_CLK_ENABLE()  __HAL_RCC_DMA1_CLK_ENABLE()

#define W5500_SPI_SCLK_PIN          (GPIO_PIN_10)
#define W5500_SPI_SCLK_PORT         (GPIOC)
#define W5500_SPI_SCLK_AF           (GPIO_AF6_SPI3)

#define W5500_SPI_MISO_PIN          (GPIO_PIN_11)
#define W5500_SPI_MISO_PORT         (GPIOC)
#define W5500_SPI_MISO_AF           (GPIO_AF6_SPI3)

#define W5500_SPI_MOSI_PIN          (GPIO_PIN_12)
#define W5500_SPI_MOSI_PORT         (GPIOC)
#define W5500_SPI_MOSI_AF           (GPIO_AF6_SPI3)

#define W5500_SPI_SSEL_PIN          (GPIO_PIN_15)
#define W5500_SPI_SSEL_PORT         (GPIOA)
#define W5500_SPI_SSEL_HIGH()       HAL_GPIO_WritePin(W5500_SPI_SSEL_PORT, W5500_SPI_SSEL_PIN, GPIO_PIN_SET)
#define W5500_SPI_SSEL_LOW()        HAL_GPIO_WritePin(W5500_SPI_SSEL_PORT, W5500_SPI_SSEL_PIN, GPIO_PIN_RESET)
...
#define W5500_INT_EXTI_IRQN         (EXTI0_IRQn)
#define W5500_INT_EXTI_LINE         (0)
#define W5500_INT_EXTI_GPIO         (EXTI_GPIOE)

// User LEDs for beacon detection status
#define OMV_LED1_PIN                (GPIO_PIN_1)   // Red LED
#define OMV_LED1_PORT               (GPIOA)
#define OMV_LED1_ON()               HAL_GPIO_WritePin(OMV_LED1_PORT, OMV_LED1_PIN, GPIO_PIN_SET)
#define OMV_LED1_OFF()              HAL_GPIO_WritePin(OMV_LED1_PORT, OMV_LED1_PIN, GPIO_PIN_RESET)

#define OMV_LED2_PIN                (GPIO_PIN_8)   // Green LED
#define OMV_LED2_PORT               (GPIOA)
#define OMV_LED2_ON()               HAL_GPIO_WritePin(OMV_LED2_PORT, OMV_LED2_PIN, GPIO_PIN_SET)
#define OMV_LED2_OFF()              HAL_GPIO_WritePin(OMV_LED2_PORT, OMV_LED2_PIN, GPIO_PIN_RESET)

#define OMV_LED3_PIN                (GPIO_PIN_2)   // Blue LED
#define OMV_LED3_PORT               (GPIOE)
#define OMV_LED3_ON()               HAL_GPIO_WritePin(OMV_LED3_PORT, OMV_LED3_PIN, GPIO_PIN_SET)
#define OMV_LED3_OFF()              HAL_GPIO_WritePin(OMV_LED3_PORT, OMV_LED3_PIN, GPIO_PIN_RESET)
